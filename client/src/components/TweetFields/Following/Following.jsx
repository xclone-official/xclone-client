...
const VerifiedAcccount = () => {
  return (
    <svg
      ...
      role="img"
      class="r-1cvl2hr r-4qtqp9 r-yyyyoo r-1xvli5t r-9cviqr r-175jvib r-1c647hd r-bnwqim r-1plcrui r-lrvibr"
...
export default function Following() {
  ...
  const [showInitialArrayOfData, setShowInitialArrayOfData] = useState(
    followingTweet.slice(0, initialPageCount)
  );

  const fetchMoreData = () => {
    console.log("Called");
    const newPageCount = initialPageCount + 2;
    const newTweets = followingTweet.slice(initialPageCount, newPageCount);
