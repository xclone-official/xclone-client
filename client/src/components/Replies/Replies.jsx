...
export default function Replies({ tweetdata }) {
  ...
  return (
    <>
      ...
      specifictweetPage?.comments?.some((e) => e._id === commentId)?.length ===
        0 ? (
        <>
          <br />
          <br />
          ...
          <div className="overflow_scrolll">
            ...
            <div className="tweet_media padding_wrap">
              {specifictweetPage?.comments?.find((e) => e._id === commentId)
                ...
                specifictweetPage?.comments?.find((e) => e._id === commentId)
                  ?.photos?.length > 1 ? (
                  specifictweetPage?.comments
                    ?.find((e) => e._id === commentId)
                    ?.photos?.map((e) => (
                      <img
                        key={e}
            ...
            <PostField tweetId={tweetdata?._id} replies={true} />
                              ...
                              <div className="comment_name_username_time">
                                ...
                                <div className="comment_text">
                                  <p>
                                    ...
                                    <br /> How would you suggest someone assess
                                    if they possess that engaging personality to
                                    host a podcast or Twitter spaces
                                    successfully?
                                  </p>
                                </div>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                <div className="cmt_time">
                                  <p>
                                    {customTimeFormat(comment?.commenttime)}
                                  </p>
                                </div>
                              </Link>
                              <div
